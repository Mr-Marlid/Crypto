# Реализовать программный продукт построения sha-384 для введенного текста.

import hashlib

def gen_sha384(input_text):
...
print("SHA-384 хэш введённого текста:", gen_sha384(input_text))
