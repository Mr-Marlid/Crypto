# Реализовать класс вычисления целых степеней по заданному
...
mod_exp = ModulExp(19) # mod 19
print(mod_exp.pow_mod(3, 5))  # 3^5 mod 19
print(mod_exp.pow_mod(3, -5))  # 3^(-5) mod 19, используя обратный элемент и теорему Эйлера
